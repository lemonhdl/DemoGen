...
from diffusion_policies.model_dp3.diffusion.mask_generator import LowdimMaskGenerator
...
from diffusion_policies.model_idp3.vision_3d.pointnet_extractor import iDP3Encoder

class ImprovedDP3Policy(BasePointcloudPolicy):
    def __init__(self, 
            shape_meta: dict,
