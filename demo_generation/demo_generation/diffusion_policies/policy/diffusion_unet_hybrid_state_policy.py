...
from diffusion_policies.model_dp3.vision_3d.pointnet_extractor import StateEncoder


class DiffusionUnetHybridStatePolicy(BasePointcloudPolicy):
    def __init__(self, 
            shape_meta: dict,
        ...
        obs_encoder = StateEncoder(observation_space=obs_dict,)
